...
function setup() {
    ...
    img = loadImage("avatargif.gif"); //load gif
}
...
function draw() {
    ...
    if (mouseIsPressed && mouseX > 800 && mouseX < 900 && mouseY > 200 && mouseY < 300) {
        background(0);
        text("Here are few things to know about me: I like apples, water, walking, and being playful. Do you want to play with me?", 200, 200);
    }
    rect(800, 200, 100, 100);
    text("click box", 800, 200);
}
